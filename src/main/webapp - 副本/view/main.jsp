...
<body>
	...
	<div id="_menu">
		<ul class="nav">
			<li class="item"><a class="init" href="${path}/view/home.jsp" title="主页"><i
					class="icon iconfont">&#xf012b;</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;主页</a></li>
			<li class="item"><a href="${path}/view/storage.jsp" title="系统监控"><i
					class="icon iconfont">&#xf0025;</i>&nbsp;&nbsp;系统监控</a></li>
					<!-- 
			<li class="item"><a href="${path}/view/prediction.jsp" title="系统预测"><i
					class="icon iconfont">&#xf00d0;</i>&nbsp;&nbsp;系统预测</a></li>
					 -->
			<li class="item"><a href="${path}/view/usermanager.jsp" title="用户管理"> <i
